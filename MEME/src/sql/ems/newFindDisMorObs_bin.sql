#
# SNOMED finding or disorder and morp-abn or obs-ent with same name not merged
# bcarlsen@msdinc.com
...
substr(a1.atom_name, instr(a1.atom_name, '(', -1)+1, length(substr(a1.atom_name, instr(a1.atom_name, '(', -1)))-2) in ( 'finding','disorder') and
substr(a2.atom_name, instr(a2.atom_name, '(', -1)+1, length(substr(a2.atom_name, instr(a2.atom_name, '(', -1)))-2) in ('morphologic abnormality', 'observable entity','disorder')
