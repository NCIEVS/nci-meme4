# SNOMED qual-val or cont-dep-cat and anything with same name not merged
# carlsen@apelon.com
...
substr(a1.atom_name, instr(a1.atom_name, '(', -1)+1, length(substr(a1.atom_name, instr(a1.atom_name, '(', -1)))-2) in ('context-dependent category','qualifier value')
