...
public class UpdateMapSetAction
  ...
  public ActionForward execute(ActionMapping actionMapping,
    ...
    try {
      ...
      mapping.setMapSetIdentifier(mapset, new Identifier.Default(mapSetActionForm.getMapSetIdentifier()));
      ...
      mapping.setAttribute(mapset,mapSetActionForm.getMAPSETVERSION(),"MAPSETVERSION");
      ...
      mapping.setAttribute(mapset, mapSetActionForm.getMAPSETSEPARATORCODE(),
                           "MAPSETSEPARATORCODE");
      mapping.setAttribute(mapset, mapSetActionForm.getMTH_UMLSMAPSETSEPARATOR(),
