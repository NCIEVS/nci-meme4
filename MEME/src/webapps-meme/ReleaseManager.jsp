...
<BODY>
<SPAN id="blue"><CENTER>Release Manager</CENTER></SPAN>
<HR width="100%">
<CENTER>
<TABLE width="95%" border="0">
  <FORM name="connection" method="GET" >
  <INPUT name="state" type="hidden" value="ReleaseManager">
    <TR>
      <TH colspan="3">&nbsp;</TH>
    </TR>
    <TR>
    ...
    <tr>
      <th colspan="3">Release Manager</th>
...
<%
  ...
  release_name = release_info[0].getName();
...
<% } %>
    ...
    <tr>
      <td colspan="2">&nbsp;</td>
       ...
       <tr> <td width="30%">&nbsp;</td>
	   <td width="70%"><input accesskey="n" class="SPECIAL" type="button" name="New" value="New Release"
	              onClick="document.form2.submit()"></td>
       </tr>

</form>
   </table>
<FORM  name ="form2" method="get" action="controller" >
<input type="hidden" name="state" value="NewReleaseForm">
