...
<BODY bgcolor="#ffffff">
  <h2>
    <center>Review Insertion Works</center>
  </h2>
  <HR WIDTH=100%>
  ...
  <center>
    <table WIDTH="90%">
      <tr>
        ...
        <td>
          <html:form action="/viewInsertionReport">
            <bean:define id="midService" name="insertionReportBean" property="midService" />
      ...
      <tr>
        ...
        <td>
          <html:select name="insertionReportBean" property="range" onchange="this.form.submit(); return true;">
      ...
      <tr>
        <td width="25%">Work:</td>
        <td>
          <html:form action="/viewInsertionReportDetails" method="get">
