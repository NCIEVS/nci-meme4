...
%>
      <TABLE border=0>
        ...
        <TR>
         ...
         <TD align="left"><FONT size="-1"></FONT><%= cv_bean.getSubCategory() == null ? "" : cv_bean.getSubCategory() %></TD>
        </TR>
        <TR>
         <TD align="right"><FONT size="-1"><B>Previous Meta:</B></FONT></TD>
         <TD align="left"><FONT size="-1"><%= cv_bean.getPreviousMeta() == null ? "" : cv_bean.getPreviousMeta() %></FONT></TD>
        </TR>
        <TR>
...
Click <A href="controller?state=ContentViewEditor">here</A> to return to the content view editor page.
      </P>
