...
<CENTER>
  <TABLE width="40%" border="0">
    ...
    <FORM method="POST" action="../viewContentViewMembers.do">
     <INPUT name="contentViewId" type="hidden" value="<%= request.getParameter("cv") %>">
     <INPUT name="success" type="hidden" value="">
     <TR><TD>&nbsp;</TD></TR>
     <TR >
       <TD align="center">
        <FONT size="-1">
        <INPUT type="button" value="View Atom Members"
               onMouseOver='window.status="View Content View Atom Member";'
               onMouseOut='window.status="";'
