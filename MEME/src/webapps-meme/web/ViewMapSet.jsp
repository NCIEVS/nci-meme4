...
<table align="center" width="90%" border="0">
  ...
  <tr>
      <td>Version (MAPSETVERSION):</td>
    <td>
      <logic:present name="MAPSETVERSION">
        <bean:write name="MAPSETVERSION"/>
      </logic:present>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>
      <logic:present name="MTH_UMLSMAPSETSEPARATOR">
        <bean:write name="MTH_UMLSMAPSETSEPARATOR"/>
      </logic:present>
    </td>
  </tr>
  <tr>
