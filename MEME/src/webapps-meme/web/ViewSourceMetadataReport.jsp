...
<title>SourceMetadataReport - <bean:write name="report" property="midService"/></title>
</head>
<body bgcolor="#ffffff">
  <h1>
  ...
  <TABLE WIDTH=90% border="1" align="center">
    ...
    <logic:iterate id="diff" name="attributeNameDifferences">
      <tr>
        ...
        <td valign="top">
		  ...
		  <bean:size id="valueSize" name="diff" property="oldValues" />          
        ...
        <td valign="top">
          <table border="1" width="100%">
		  <bean:size id="valueSize" name="diff" property="newValues" />          
          <logic:equal value="0" name="valueSize">
          	&nbsp;
          </logic:equal>
            <logic:iterate id="value" name="diff" property="newValues">
    ...
    <TR>
      <TH colspan="4">Suppressible Differences</TH>
    </TR>
    <tr>
      <th>Differences</th>
      <th>Count</th>
    ...
    <logic:iterate id="diff" name="suppressibleDifferences">
      <tr>
        <td valign="top">
          <bean:write name="diff" property="name"/>
        </td>
