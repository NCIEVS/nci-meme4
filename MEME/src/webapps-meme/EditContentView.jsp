...
<SCRIPT LANGUAGE="JavaScript">
  ...
  function form2Submit(form, command) {
    ...
    var str = previousMeta.value;
    if (str == "") {
      alert ("The content view previous meta must not be null.");
      previousMeta.focus();
      return false;
    }
    ...
    str = subCategory.value;
    if (str == "") {
      alert ("The content view sub category must not be null.");
      subCategory.focus();
      return false;
    }
