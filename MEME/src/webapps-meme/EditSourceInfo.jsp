...
<center><table CELLPADDING=2 WIDTH="90%"  >
	...
	<td><font size="-1"><textarea name="license_contact" wrap="soft" cols="60" rows="4"><%= (source.getLicenseContact() == null ? "" : source.getLicenseContact())%></textarea></font></td>
    </tr>
	...
	<td><font size="-1"><textarea name="content_contact" wrap="soft" cols="60" rows="4"><%= (source.getContentContact() == null ? "" : source.getContentContact())%></textarea></font></td>
    </tr>
	...
	<td><font size="-1"><textarea name="citation" wrap="soft" cols="60" rows="4"><%= (source.getCitation() == null ? "" : source.getCitation())%></textarea></font></td>
    </tr>
	...
	<td><font size=-1>
		...
		onClick="openDescription('Restriction Level',
                   'The restriction level has to do with the various levels of lisence agreements.  There are currently four possible values: 0,1,2, and 3.');">SRL</a>:</font></td>
	...
	<td><font size="-1"></font><%= (source.getAttributeNameList() == null ? "" : source.getAttributeNameList())%></font></td>
    </tr>
