...
CREATE TABLE MRMAP (
    ...
    TOSID	varchar2(50),
    TOEXPR	varchar2(4000) NOT NULL,
    TOTYPE	varchar2(50) NOT NULL,
    TORULE	varchar2(4000),
    TORES	varchar2(4000),
    MAPRULE	varchar2(4000),
    MAPRES	varchar2(4000),
    MAPTYPE	varchar2(50) NOT NULL,
    MAPATN	varchar2(100),
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE AMBIGSUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE AMBIGLUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE DELETEDCUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE DELETEDLUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE DELETEDSUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE MERGEDCUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
...
BEGIN EXECUTE IMMEDIATE 'DROP TABLE MERGEDLUI'; EXCEPTION WHEN OTHERS THEN NULL; END;
/
