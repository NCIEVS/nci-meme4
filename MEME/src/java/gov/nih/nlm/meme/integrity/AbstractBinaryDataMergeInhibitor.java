 ...
 * Object:  AbstractBinaryDataMergeInhibitor
 *
 *****************************************************************************/
 ...
 * such checks as {@link MGV_K}.
 *
 * @author MEME Group
 */

public abstract class AbstractBinaryDataMergeInhibitor extends
    AbstractMergeInhibitor implements BinaryDataIntegrityCheck {
  ...
  /**
   * Instantiates an empty {@link AbstractBinaryDataMergeInhibitor}.
   */
  public AbstractBinaryDataMergeInhibitor() {
    super();
  }
