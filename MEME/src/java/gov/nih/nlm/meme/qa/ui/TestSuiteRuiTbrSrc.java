...
/**
 * Test suite for Rui Tbr Src
 */
public class TestSuiteRuiTbrSrc extends TestSuite {

  private int concept_id2 = 101;

  public TestSuiteRuiTbrSrc() {
    setName("TestSuiteRuiTbrSrc");
    setDescription("Test Suite for Rui Tbr Src");
    setConceptId(100);
  }

  /**
   * Perform Test Suite Rui Tbr Src
   */
  public void run() {
    ...
    try {
      ...
      int rel_id = 0;
      Relationship[] rels = client.getRelationships(concept1);
      ...
      // Compare Rui
      if ((rui1 == null || rui1.equals("")) && (irui1 == null || irui1.equals("")))
      ...
      addToLog("        RUI should not be null and RUI should not be empty string");
      ...
      // Compare Rui
      if ((rui2 != null || rui2.equals("")) && (irui2 != null || rui2.equals("")))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteRuiTbrSrc at " + date_format.format(new Date(System.currentTimeMillis())));
      addToLog("-------------------------------------------------------");
