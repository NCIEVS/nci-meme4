 ...
 * Object:  MolecularInsertAttributeActionTest
 * 
...
public class MolecularInsertAttributeActionTest
    extends TestSuite{

  /**
   * Instantiates an empty {@link MolecularInsertAttributeActionTest}.
   */	
  public MolecularInsertAttributeActionTest() {
    setName("MolecularInsertAttributeActionTest");
    setDescription("Test suite for molecular insert attribute actions");
  }
  
  /**
   * Perform molecular insert attribute action test.
   */
  public void run() {
    ...
    try {
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MolecularInsertAttributeActionTest at " +
