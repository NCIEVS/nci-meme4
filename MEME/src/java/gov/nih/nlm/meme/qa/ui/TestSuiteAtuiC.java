...
/**
 * Performs a series of actions on a concept-level attribute and
 ...
 * <ol>
 *   <li>Insert initial data, including concept level attribute.
 *   <li>Change atom id</li>
 *   <li>Change concept id</li>
 *   <li>Undo initial insert</li>
 * </ol>
 */
public class TestSuiteAtuiC extends TestSuite {

  //
  // Use this test concept id
  //
  private int concept_id2 = 101;

  /**
   * Instantiates an empty {@link TestSuiteAtuiC}.
   */
  public TestSuiteAtuiC() {
    setName("TestSuiteAtuiC");
    setDescription("Test Suite for ATUI C");
    setConceptId(100);
  }

  /**
   * Perform Test Suite Atui C.
   */
  public void run() {
    ...
    try {
      ...
      // Re-read atom
      int atom_id = client.getMaxIdentifierForType(Atom.class).intValue();
      ...
      // Re-read atom
      atom_id = client.getMaxIdentifierForType(Atom.class).intValue();
      atom2 = client.getAtom(atom_id);

      //
      // 1b. Insert a concept level attribute
      //
      ...
      MolecularMoveAction ma2a = new MolecularMoveAction(concept1, concept2);
      ma2a.addAtomToMove(atom);
      ...
      MolecularMoveAction ma2b = new MolecularMoveAction(concept2, concept1);
      ma2b.addAtomToMove(atom2);
      ...
      attr = client.getAttribute(attr_id);
      atui2 = attr.getATUI();
      addToLog("        concept ID: " + attr.getConcept().getIdentifier());
      addToLog("        atui: " + atui2.toString());
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteAtuiC at " +
