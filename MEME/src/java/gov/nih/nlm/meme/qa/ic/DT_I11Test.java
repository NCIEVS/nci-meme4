...
import gov.nih.nlm.meme.integrity.DT_I11;
...
public class DT_I11Test extends TestSuite{

  /**
   * Instantiates an empty {@link DT_I11Test}.
   */	
  public DT_I11Test() {
    setName("DT_I11Test");
    setDescription("Test suite for DT_I11 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      DT_I11 ic = (DT_I11) adc.getIntegrityCheck("DT_I11");
      ...
      addToLog("        Should not be a violation. No different related concept found ...");
      ...
      addToLog("        Should be a violation. Found a different related concept ...");
      if (ic.validate(concept))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished DT_I11Test at " +
