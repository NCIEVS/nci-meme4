...
import gov.nih.nlm.meme.integrity.MGV_MM;
...
public class MGV_MMTest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_MMTest}.
   */	
  public MGV_MMTest() {
    setName("MGV_MMTest");
    setDescription("Test suite for MGV_MM integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_MM ic = (MGV_MM) adc.getIntegrityCheck("MGV_MM");
      ...
      addToLog("        Should not be a violation. No releasable MTH/MM atoms in both source and target found ...");
      ...
      addToLog("        Should be a violation. Found releasable MTH/MM atoms in both source and target. ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_MMTest at " +
