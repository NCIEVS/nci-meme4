...
import gov.nih.nlm.meme.integrity.MGV_B2;
...
public class MGV_B2Test extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_B2Test}.
   */	
  public MGV_B2Test() {
    setName("MGV_B2Test");
    setDescription("Test suite for MGV_B2 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_B2 ic = (MGV_B2) adc.getIntegrityCheck("MGV_B2");
      ...
      BinaryCheckData[] bcds = new BinaryCheckData [] { 
      	new BinaryCheckData("MGV_B2","SOURCE","SOURCE","MTH","MTH",false),
      	new BinaryCheckData("MGV_B2","SOURCE","SOURCE","MTH","MTH",false)
      };
      ...
      addToLog("        Should not be a violation. No cases of merges where source and target atoms have sources in the pairs from above found ...");
      ...
      addToLog("        Should be a violation. Found cases of merges where source and target atoms have sources in the pairs from above ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_B2Test at " +
