...
import gov.nih.nlm.meme.integrity.MGV_MUI;
...
public class MGV_MUITest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_MUITest}.
   */	
  public MGV_MUITest() {
    setName("MGV_MUITest");
    setDescription("Test suite for MGV_MUI integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_MUI ic = (MGV_MUI) adc.getIntegrityCheck("MGV_MUI");
      ...
      addToLog("        Should not be a violation. No cross-MUI merges among current-version MSH atoms found. ...");
      ...
      addToLog("        Should be a violation. Found cross-MUI merges among current-version MSH atoms. ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_MUITest at " +
