...
public class MGV_A4Test extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_A4Test}.
   */	
  public MGV_A4Test() {
    setName("MGV_A4Test");
    setDescription("Test suite for MGV_A4 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_A4 ic = (MGV_A4) adc.getIntegrityCheck("MGV_A4");
      ...
      addToLog("        Should not be a violation. No releasable atom from source concept having different last release cui from releasable target concept atom found ...");
      ...
      addToLog("        Should be a violation. Found releasable atom from source concept having different last release cui from releasable target concept atom ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_A4Test at " +
