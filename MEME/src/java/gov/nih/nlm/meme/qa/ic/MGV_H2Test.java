...
import gov.nih.nlm.meme.integrity.MGV_H2;
...
public class MGV_H2Test extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_H2Test}.
   */	
  public MGV_H2Test() {
    setName("MGV_H2Test");
    setDescription("Test suite for MGV_H2 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_H2 ic = (MGV_H2) adc.getIntegrityCheck("MGV_H2");
      ...
      addToLog("        Should not be a violation. No cases where releasable current version MSH atoms with ");
      addToLog("        different codes (in the specific combinations) are being merged. ...");
      ...
      atom.setSource(src);
      atom.setCode(Code.newCode("C000959"));      
      atom.setStatus('R');
      ...
      addToLog("        Should be a violation. Found cases where releasable current version MSH atoms with ");
      addToLog("        different codes (in the specific combinations) are being merged. ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_H2Test at " +
