...
import gov.nih.nlm.meme.integrity.MGV_H1;
...
public class MGV_H1Test extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_H1Test}.
   */	
  public MGV_H1Test() {
    setName("MGV_H1Test");
    setDescription("Test suite for MGV_H1 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_H1 ic = (MGV_H1) adc.getIntegrityCheck("MGV_H1");
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_H1Test at " +
