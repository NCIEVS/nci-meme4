...
/**
 * Test suite for Rui SRC
 */
public class TestSuiteRuiSRC
    extends TestSuite {

  private int concept_id2 = 101;
  private int concept_id3 = 102;

  public TestSuiteRuiSRC() {
    setName("TestSuiteRuiSRC");
    setDescription("Test Suite for Rui SRC");
    setConceptId(100);
  }

  /**
   * Perform Test Suite Rui SRC
   */
  public void run() {
    ...
    try {
      ...
      // Re-read atom
      int atom_id1 = 0;
      Atom[] atoms = concept1.getAtoms();
      for (int i = 0; i < atoms.length; i++) {
        if (atoms[i].isReleasable()) {
          atom_id1 = atoms[i].getIdentifier().intValue();
        }
      }
      ...
      for (int i = 0; i < atoms.length; i++) {
        if (atoms[i].isReleasable()) {
          atom_id2 = atoms[i].getIdentifier().intValue();
        }
      }
      ...
      // Re-read atom
      int atom_id3 = 0;
      atoms = concept3.getAtoms();
      for (int i = 0; i < atoms.length; i++) {
        if (atoms[i].isReleasable()) {
          atom_id3 = atoms[i].getIdentifier().intValue();
        }
      }
      atom3 = client.getAtom(atom_id3);
      ...
      // Compare Rui
      if (!rui1.equals(rui3) && rui2.equals(rui3) && !irui1.equals(irui3) &&
          irui2.equals(irui3))
      ...
      //
      addToLog(
          "    3a. Test change the relationship name of the relationships ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should change");
      rel.setName("BRT");
      ...
      //
      addToLog(
          "    3b. Test change relationship name of the relationships back ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should return to initial value");
      rel.setName("RT");
      ...
      //
      addToLog(
          "    4a. Test change the relationship attribute of the relationships ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should change");
      ...
      //
      addToLog(
          "    4b. Test change relationship attribute of the relationships back ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should return to initial value");
      rel.setAttribute("mapped_to");
      ...
      //
      addToLog(
          "    7b. Test change concept id 1 of the relationships back ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should return to initial value");
      rel.setConcept(concept1);
      ...
      MolecularAction ma8a = new MolecularChangeRelationshipAction(rel);
      ...
      //
      addToLog(
          "    8b. Test change concept id 1 of the relationships back ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should return to initial value");
      rel.setRelatedConcept(concept2);
      MolecularAction ma8b = new MolecularChangeRelationshipAction(rel);
      ...
      //
      addToLog(
          "    9a. Test change the relationship level of the relationships ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should change");
      rel.setLevel('C');
      ...
      //
      addToLog(
          "    9b. Test change relationship level of the relationships back ... "
          + date_format.format(timestamp));
      addToLog("        RUI and inverse RUI should return to initial value");
      rel.setLevel('P');
      ...
      inverse_rel = client.getInverseRelationship(rel_id);
      RUI irui4 = inverse_rel.getRUI();

      addToLog("        rui: " + rui4.toString());
      addToLog("        irui: " + irui4.toString());

      // Compare Rui
      if (!rui1.equals(rui4) && !irui1.equals(irui4))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteRuiSRC at " +
