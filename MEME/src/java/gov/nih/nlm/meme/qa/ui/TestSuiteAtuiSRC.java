...
/**
 * Test suite for Atui SRC
 */
public class TestSuiteAtuiSRC extends TestSuite {

  private int concept_id2 = 101;

  public TestSuiteAtuiSRC() {
    setName("TestSuiteAtuiSRC");
    setDescription("Test Suite for Atui SRC");
    setConceptId(100);

  }

  /**
   * Perform Test Suite Atui SRC
   */
  public void run() {
    ...
    try {
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteAtuiSRC at " + date_format.format(new Date(System.currentTimeMillis())));
      addToLog("-------------------------------------------------------");
