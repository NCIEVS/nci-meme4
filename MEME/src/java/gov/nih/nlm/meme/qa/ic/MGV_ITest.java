...
import gov.nih.nlm.meme.integrity.MGV_I;
...
public class MGV_ITest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_ITest}.
   */	
  public MGV_ITest() {
    setName("MGV_ITest");
    setDescription("Test suite for MGV_I integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_I ic = (MGV_I) adc.getIntegrityCheck("MGV_I");
      ...
      UnaryCheckData[] ucds = new UnaryCheckData [] { 
        	new UnaryCheckData("MGV_I","SOURCE","MTH",false),
        	new UnaryCheckData("MGV_I","SOURCE","MTH",false)
        };
      ...
      addToLog("        Should not be a violation. No cases of merges where the sources are the same but codes are different found ...");
      ...
      addToLog("        Should be a violation. Found cases of merges where the sources are the same but codes are different. ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_ITest at " +
