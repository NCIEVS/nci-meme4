...
public class MGV_RX2Test extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_RX2Test}.
   */	
  public MGV_RX2Test() {
    setName("MGV_RX2Test");
    setDescription("Test suite for MGV_RX2 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_RX2 ic = (MGV_RX2) adc.getIntegrityCheck("MGV_RX2");
      ...
      addToLog("        Should not be a violation. No rx2 atoms from source/target found ...");
      ...
      addToLog("        Should be a violation. Found an RX2 merge ...");
      if (ic.validate(source, target))
      ...
      addToLog("        Should not be a violation. RX2 merge not found ...");
      if (!ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_RX2Test at " +
