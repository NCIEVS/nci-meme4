...
import gov.nih.nlm.meme.integrity.MGV_RXCUI;
...
public class MGV_RXCUITest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_RXCUITest}.
   */	
  public MGV_RXCUITest() {
    setName("MGV_RXCUITest");
    setDescription("Test suite for MGV_RXCUI integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_RXCUI ic = (MGV_RXCUI) adc.getIntegrityCheck("MGV_RXCUI");
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_RXCUITest at " +
