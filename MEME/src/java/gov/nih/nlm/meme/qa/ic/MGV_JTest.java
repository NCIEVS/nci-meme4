...
import gov.nih.nlm.meme.integrity.MGV_J;
...
public class MGV_JTest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_JTest}.
   */	
  public MGV_JTest() {
    setName("MGV_JTest");
    setDescription("Test suite for MGV_J integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_J ic = (MGV_J) adc.getIntegrityCheck("MGV_J");
      ...
      BinaryCheckData[] bcds = new BinaryCheckData [] { 
      	new BinaryCheckData("MGV_J","SOURCE","SOURCE","MTH","MTH",false),
      	new BinaryCheckData("MGV_J","SOURCE","SOURCE","MTH","MTH",false)
      };
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_JTest at " +
