...
import gov.nih.nlm.meme.integrity.DT_M1;
...
public class DT_M1Test extends TestSuite{

  /**
   * Instantiates an empty {@link DT_M1Test}.
   */	
  public DT_M1Test() {
    setName("DT_M1Test");
    setDescription("Test suite for DT_M1 integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      DT_M1 ic = (DT_M1) adc.getIntegrityCheck("DT_M1");
      ...
      addToLog("        Should be a violation. No STY found ...");
      ...
      //
      // 2a. Insert a concept with releasable semantic type
      //
      ...
      addToLog("    2a. Insert a concept with releasable semantic type ... " + date_format.format(timestamp));
      ...
      addToLog("        Should not be a violation. Releasable approved STY found ...");
      if (!ic.validate(concept))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished DT_M1Test at " +
