...
/**
 * Test suite for Atui TBR SRC
 */
public class TestSuiteAtuiTbrSrc extends TestSuite {

  private int concept_id2 = 101;

  public TestSuiteAtuiTbrSrc() {
    setName("TestSuiteAtuiTbrSrc");
    setDescription("Test Suite for Atui TBR SRC");
    setConceptId(100);
  }

  /**
   * Perform Test Suite Atui TBR SRC
   */
  public void run() {
    ...
    try {
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteAtuiTbrSrc at " + date_format.format(new Date(System.currentTimeMillis())));
      addToLog("-------------------------------------------------------");
