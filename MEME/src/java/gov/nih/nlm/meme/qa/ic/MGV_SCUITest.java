...
public class MGV_SCUITest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_SCUITest}.
   */	
  public MGV_SCUITest() {
    setName("MGV_SCUITest");
    setDescription("Test suite for MGV_SCUI integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_SCUI ic = (MGV_SCUI) adc.getIntegrityCheck("MGV_SCUI");
      ...
      addToLog("        Should not be a violation. No cases of merges where the sources are the same but concept id are different found ...");
      ...
      addToLog("        Should be a violation. Found cases of merges where the sources are the same but concept id are different. ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_SCUITest at " +
