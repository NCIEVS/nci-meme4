...
/**
 * Performs a series of actions on a source-level attribute with non-null
 * native identifier and
 ...
 * <ol>
 *   <li>Insert initial data, including source level attribute with
 *       non-null native identifier</li>
 *   <li>Change atom id</li>
 *   <li>Change concept id</li>
 *   <li>Undo initial insert</li>
 * </ol>
 */
public class TestSuiteAtuiSG2
    extends TestSuite {

  private int concept_id2 = 101;

  /**
   * Instantiates an empthy {@link TestSuiteAtuiSG2}.
   */
  public TestSuiteAtuiSG2() {
    setName("TestSuiteAtuiSG2");
    setDescription("Test Suite for Atui SG2");
    setConceptId(100);
  }

  /**
   * Perform Test Suite Atui SG2.
   */
  public void run() {
    ...
    try {
      ...
      attr.setNativeIdentifier(new NativeIdentifier("CODE", "SOURCE_AUI", "MTH",
          "", ""));
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished TestSuiteAtuiSG2 at " +
