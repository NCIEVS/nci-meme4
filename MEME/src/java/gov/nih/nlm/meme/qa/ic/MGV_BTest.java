...
import gov.nih.nlm.meme.integrity.MGV_B;
...
public class MGV_BTest extends TestSuite{

  /**
   * Instantiates an empty {@link MGV_BTest}.
   */	
  public MGV_BTest() {
    setName("MGV_BTest");
    setDescription("Test suite for MGV_B integrity");
  }
  ...
  public void run() {
    ...
    try {
      ...
      MGV_B ic = (MGV_B) adc.getIntegrityCheck("MGV_B");
      ...
      addToLog("        Should not be a violation. No cases of within-source merges involving releasable atoms found ...");
      ...
      addToLog("        Should be a violation. Found cases of within-source merges involving releasable atoms ...");
      if (ic.validate(source, target))
      ...
      addToLog("-------------------------------------------------------");
      addToLog("Finished MGV_BTest at " +
