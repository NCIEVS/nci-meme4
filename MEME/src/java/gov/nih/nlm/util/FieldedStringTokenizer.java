 ...
 * Unlike the {@link java.util.StringTokenizer} it recognizes empty tokens.
 ...
 * </pre>
 *
 * This class can also be used in a static way to split a line
 * on a particular character delmiter and have a <code>String[]</code>
...
public class FieldedStringTokenizer implements Enumeration {
  ...
  /**
   * Instantiates a {@link FieldedStringTokenizer} for the specified string.
  ...
  public FieldedStringTokenizer(String str, String delim) {
    ...
    //
    tokens = new ArrayList(token_array.length + 1);
  ...
  /**
   * Splits a line on delimiter characters and returns a
   * {@link String}<code>[]</code> of the tokens.
  ...
  public static String[] split(String line, String delim) {
    ...
    //
    final List tokens = new ArrayList(20);
  ...
  /**
   * Splits a line on delimiter characters when the number
   * of fields is known in advance and returns a string array of the tokens.
   * @param line a {@link String} to be split
   * @param delim a {@link String} containing delimiter characters
  ...
  /**
   * Splits a line on delimiter characters when the number
   * of fields is known in advance and populates the specified String[].
   * @param line a {@link String} to be split
   * @param delim a {@link String} containing delimiter characters
   * @param field_ct <code>int</code> indicates the max number of fields to split
  ...
  /**
   * Returns the same value as the {@link #hasMoreTokens()} method.
   ...
   * tokenizer's string. If this method returns true,
   * then a subsequent call to {@link #nextToken()} will
  ...
  /**
   * Returns the same value as the {@link #nextToken()} method,
   * except that its declared return value is {@link Object}
   * rather than {@link String}. It exists so that this class
   * can implement the {@link Enumeration} interface.
  ...
  public String nextToken() {
    String token = (String) tokens.get(ct++);
    return token;
  }

  /**
   * Self-qa test.
   * @param args a {@link String}<code>[]</code> containing
