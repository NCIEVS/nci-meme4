 ...
 * for gov.nih.nlm.mrd.sql package.
 *
 * <b>History</b>
 * <dl>
 * <dt>XX/XX/XXXX:</dt>
...
public class Version {
  ...
  private final static String package_name = "gov.nih.nlm.mrd.sql";
   ...
   * on the command line.
   * @param argv An array of object {@link String} representation of argument.
   */
  public static void main(String argv[]) {
    System.out.println(gov.nih.nlm.mrd.sql.Version.getVersionInformation());
  }
}
