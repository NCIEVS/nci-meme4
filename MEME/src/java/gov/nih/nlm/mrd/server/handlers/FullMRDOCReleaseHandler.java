...
/**
 * Handler for "MRDOC" target.
 *
 * @author TTN, BAC
 */
public class FullMRDOCReleaseHandler extends ReleaseHandler.Default {

  /**
   * Instantiates a {@link FullMRDOCReleaseHandler}.
   */
  public FullMRDOCReleaseHandler() {
    setProcess("RELEASE");
    setType("Full");
  }

  /**
   * Calls <code>MRD_RELEASE_OPERATIONS.mrdoc_prepare</code>.
  ...
  public void prepare() throws DataSourceException {
    ...
    try {
      call.append("{call MRD_RELEASE_OPERATIONS.mrdoc_prepare ()}");
  ...
  /**
   * Writes <code>MRDOC.RRF</code> to "Build URI" META directory.
  ...
  public void generate() throws MEMEException {
    ...
    File file = new File(dir_name, "MRDOC.RRF");
    ...
    writer.write(file, "mrdoc_pre", constr);
