 ...
 * Object:      FullMRDEFReleaseHandler.java
 *
 ***********************************************************************/
...
/**
 * Handler for "MRDEF" target.
 *
 * @author TTN, BAC
 */
public class FullMRDEFReleaseHandler extends ReleaseHandler.Default {

  /**
   * Instantiates {@link FullMRDEFReleaseHandler}.
   */
  public FullMRDEFReleaseHandler() {
    setProcess("RELEASE");
    setType("Full");
  }

  /**
   * Calls <code>MRD_RELEASE_OPERATIONS.mrdef_prepare</code>.
  ...
  public void prepare() throws DataSourceException {
    ...
    try {
      call.append("{call MRD_RELEASE_OPERATIONS.mrdef_prepare ()}");
  ...
  /**
   * Writes <code>MRDEF.RRF</code> to "Build URI" META directory.
  ...
  public void generate() throws MEMEException {
    ...
    File file = new File(dir_name, "MRDEF.RRF");
    ...
    writer.write(file, "mrdef_pre", constr);
