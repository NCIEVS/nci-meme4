...
import gov.nih.nlm.swing.TableMap;
...
/**
 * Sorter for {@link TableModel}s. The sorter has a model (conforming to
 * {@link TableModel}) and itself implements {@link TableModel}.
 * {@link TableSorter}does not store or copy the data in the {@link TableModel},
 ...
 * That way the {@link TableSorter}appears to hold another copy of the table
...
public class TableSorter extends TableMap {
    ...
    /**
     * Resets the sorting mechanism to wait until a header is clicked before
     * sorting the table.
     */
    ...
    /**
     * Compares data in sorted column by type. If the type is an object type, it
     ...
     * @param column
     *                  A table column
     * @return a value indicating the relative sort order of <code>row1</code>
     *             and <code>row2</code> for the specified column
     */
    ...
    /**
     * Resets the map so that the first row of the table corresponds to the
     * first index of the underlying model.
     */
    ...
    /**
     * Validates the model. This simple check verifies that the index map has
     * the same row count as the underlying model.
     */
    ...
    /**
     * Sorts the table. Actually, it sorts the appropriate column and re-orders
     * the index map to produce a sorted table column.
     * 
     * @param sender
     *                  {@link Object}
     */
    ...
    /**
     * Returns the value at the specified row and column from the underlying
     * model. This operation is performed by mapping the row index through the
     * map.
     * 
     * @param r
     *                  a table row
     * @param c
     *                  a table column
     * @return the value at the specified row and column from the underlying
     *             model
     */
     ...
     * This operation is performed by mapping the row index through the map.
     * 
     * @param r
     *                  a table row
     * @param c
    ...
    public void sortByColumn(int column, boolean ascending) {
        ...
        sort(this);
        /*
         * Soma Lanka: Comment out the table change event as we donot want to 
         * change the size of the column because of sort.
         */
    ...
    /**
     * Adds a mouse listener to the Table to trigger a table sort when a column
     * heading is clicked in the JTable.
     * 
     * @param table
     *                  the sortable {@link JTable}
     */
    public void addMouseListenerToHeaderInTable(JTable table) {
        ...
        MouseAdapter listMouseListener = new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                // Prevents 'column' variable from having value of  -1. If set,
                // it would result in java.lang.ArrayIndexOutOfBoundsException
                // being thrown when class reacts to TableModelEvent event,
                // and table has previously been sorted, i.e. header_clicked = true.
                if (tableView.convertColumnIndexToModel(viewColumn) == -1)
                    return;
