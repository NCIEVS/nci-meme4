...
import gov.nih.nlm.swing.TableSortListener;
...
public class SortableJTable extends JTable{
   ...
   */
   public void tableChanged(TableModelEvent e) {
     ...
     if (! getFinishedConstruction()) return;
  ...
  /**
   * Indicates whether or not constructor has completed.
   * @return <code>true</code> if it has, <code>false</code> otherwise
   */
  private boolean getFinishedConstruction() {
    return finished_construction;
  }
