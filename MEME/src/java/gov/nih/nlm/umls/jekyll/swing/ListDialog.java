 ...
 * <li>Return <code>null</code> instead of zero-sized array when dialog is cancelled;
 *</ul>
...
public class ListDialog extends JDialog {
   ...
   * @param initial_selection the initially selected value
  ...
  public ListDialog (
    ...
    if (initial_selection != null) {
      jvalue.setSelectedValues(initial_selection, true);
    } else {
      jvalue.selectAll();
    }
  ...
  public static Object[] showListMultipleMode (
     ...
     Object [] values, Object[] initial_selection) {
    ListDialog ld = new ListDialog(parent, message, title,
               values, initial_selection, false);
    ld.setVisible(true);
    Object[] ret_values = ld.getValues();
    ld.dispose();
    return ret_values;
  }
}
