...
public class MGV_H2Test extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		ic.setIsActive(true);
		ic.setIsFatal(true);
		ic.setShortDescription("Short description of MGV_H2");
		ic.setDescription("Description of MGV_H2.");
	...
	public void testEmptyTargetConcept() {
		System.out.println("MGV_H2Test#testEmptyTargetConcept()");
		createSourceConcept();
	...
	public void testEmptySourceConcept() {
		System.out.println("MGV_H2Test#testEmptySourceConcept()");
	...
	public void testViolationFound() {
		System.out.println("MGV_H2Test#testViolationFound()");
	...
	public void testViolationNotFoundWrongCode() {
		System.out.println("MGV_H2Test#testViolationNotFoundWrongCode()");
	...
	public void testViolationNotFoundNonSetSAB() {
		System.out.println("MGV_H2Test#testViolationNotFoundSetSAB()");
	...
	public void testViolationNotFoundNonReleasable() {
		System.out.println("MGV_H2Test#testViolationNotFoundNonReleasable()");
	...
	public void testViolationNotFoundNonCurrent() {
		System.out.println("MGV_H2Test#testViolationNotFoundNonCurrent()");
