...
public class MGV_PNTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		ic.setIsActive(true);
		ic.setIsFatal(true);
		ic.setShortDescription("Short description of MGV_PN");
		ic.setDescription("Description of MGV_PN.");
	...
	public void testEmptyTargetConcept() {
		System.out.println("MGV_PNTest#testEmptyTargetConcept()");
		createSourceConcept();
	...
	public void testEmptySourceConcept() {
		System.out.println("MGV_PNTest#testEmptySourceConcept()");
	...
	public void testViolationFound() {
		System.out.println("MGV_PNTest#testViolationFound()");
		createSourceConcept();
		createTargetConcept();
	...
	public void testViolationNotFoundNonReleasable() {
		System.out.println("MGV_PNTest#testViolationNotFoundNonReleasable()");
	...
	public void testViolationNotFoundSetTTY() {
		System.out.println("MGV_PNTest#testViolationNotFoundSetTTY()");
